...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav">
        <li id="personManagerLi"><a href="${request.contextPath}/student/1">JAVA</a></li>
        <li id="personManagerLi"><a href="${request.contextPath}/student/2">IOS</a></li>
        <li id="personManagerLi"><a href="${request.contextPath}/student/3">Android</a></li>
    </ul>
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="${request.contextPath}/currentClassify">类型选择</a></li>
    </ul>
</div><!-- /.navbar-collapse -->
</div><!-- /.container-fluid -->
</nav>
